...
wstring ModCipher::encrypt(wstring &open_text)
{
...
wstring ModCipher::decrypt(wstring &secret_text)
{
...
inline void ModCipher::validateText(wstring &text)
{
    if (text.empty())
...
inline void ModCipher::validateText(wstring &open_text, wstring &secret_text)
{
...
inline void ModCipher::validateKey(int &key, wstring &text)
{
